...
![](images/Screenshot%202024-09-22%20153345.png){fig-align="center"}
...
![](images/Screenshot%202024-09-22%20155910.png){fig-align="center"}
...
When visualizing the data using **tmap**, there are no noticeable spatial changes in accidents based on the day of the week. This suggests that the distribution of accidents remains consistent across the network, and the primary difference between days is likely the **amount of accidents**, rather than where they occur. This indicates that certain days like Friday and Saturday may simply see more traffic or activity, leading to more accidents, but without altering the overall spatial accident patterns.
