...
When exploring spNetwork’s functions, spNetwork is expecting that the geospatial data contains complete CRS information.
...
## 6.1 Preparing the Lixel Objects
...
## 6.2 Generating Line Center Points
